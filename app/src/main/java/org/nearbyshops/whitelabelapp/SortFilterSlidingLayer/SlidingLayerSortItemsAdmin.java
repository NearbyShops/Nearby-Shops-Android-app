...
public class SlidingLayerSortItemsAdmin extends Fragment {
...
//        String[] sort_options = UtilitySortShopAdmin.getSort(getActivity());
        ...
        currentSort = PrefSortItemsByCategoryAdmin.getSort(getActivity());
        currentAscending = PrefSortItemsByCategoryAdmin.getAscending(getActivity());
    ...
    void sortByNameClick(View view)
    {
        ...
        PrefSortItemsByCategoryAdmin.saveSort(getActivity(),SORT_BY_ITEM_RATING);
    ...
    void sortByCreated(View view)
    {
        ...
        PrefSortItemsByCategoryAdmin.saveSort(getActivity(),SORT_BY_POPULARITY);
    ...
    void sortByShopCount(View view)
    {
        ...
        PrefSortItemsByCategoryAdmin.saveSort(getActivity(),SORT_BY_SHOP_COUNT);
    ...
    void sortByPriceAvg(View view)
    {
        ...
        PrefSortItemsByCategoryAdmin.saveSort(getActivity(),SORT_BY_AVG_PRICE);
    ...
    void ascendingClick(View view)
    {
        ...
        PrefSortItemsByCategoryAdmin.saveAscending(getActivity(),SORT_ASCENDING);
    ...
    void descendingClick(View view)
    {
        ...
        PrefSortItemsByCategoryAdmin.saveAscending(getActivity(),SORT_DESCENDING);
