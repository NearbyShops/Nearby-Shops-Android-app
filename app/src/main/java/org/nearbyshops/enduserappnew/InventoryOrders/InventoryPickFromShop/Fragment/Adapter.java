package org.nearbyshops.enduserappnew.InventoryOrders.InventoryPickFromShop.Fragment;
...
class Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        {
            return ViewHolderOrderShopAdminPFS.create(parent,parent.getContext(),fragment);
        }
