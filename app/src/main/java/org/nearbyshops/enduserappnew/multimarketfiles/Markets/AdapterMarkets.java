...
import org.nearbyshops.enduserappnew.multimarketfiles.ViewHolderMarket.ViewHolderCurrentMarket;
...
//        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holderVH, int position) {
        ...
        {
            MarketsListData marketsList = (MarketsListData) dataset.get(position);
