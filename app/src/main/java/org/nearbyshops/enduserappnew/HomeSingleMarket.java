...
public class HomeSingleMarket extends AppCompatActivity
        implements ShowFragment, NotifyAboutLogin, MarketSelected {
...
//        showProfileFragment(true);
    ...
    void checkPermissions() {
        ...
        if(!PrefLocation.isLocationSetByUser(HomeSingleMarket.this))
        {
            startService(new Intent(HomeSingleMarket.this, LocationService.class));
        }
...
//        task.onSuccessTask( new SuccessContinuation<LocationSettingsResponse, Object>() {
//
//
//            @NonNull
//            @Override
//            public Task<Object> then(LocationSettingsResponse locationSettingsResponse) throws Exception {
//
//                showLogMessage("Location Settings Enable Success !");
//
//
//                if(!PrefLocation.isLocationSetByUser(HomePleaseSelectMarket.this))
//                {
//                    startService(new Intent(HomePleaseSelectMarket.this, LocationService.class));
//                }
//
//
//                return null;
...
//
//                showLogMessage("Location Settings Enable Success : OnComplete() !");
//
//
//                if(!PrefLocation.isLocationSetByUser(HomePleaseSelectMarket.this))
//                {
...
//        });
        ...
        task.addOnFailureListener(this, new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                showLogMessage("Location Settings Failed !");
                ...
                if (e instanceof ResolvableApiException) {
                    ...
                    try {
                        ...
                        resolvable.startResolutionForResult(HomeSingleMarket.this,
        ...
        dialog.setTitle("Do you want to exit ?")
                ...
                .setPositiveButton("Yes",new DialogInterface.OnClickListener(){
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        HomeSingleMarket.super.onBackPressed();
...
//        PrefGeneral.saveServiceURL(null,this);
    }
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(PrefGeneral.getServiceURL(HomeSingleMarket.this)==null)
                        {
