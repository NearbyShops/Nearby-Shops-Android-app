...
public class HomePleaseSelectMarket extends AppCompatActivity
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                if (e instanceof ResolvableApiException) {
                    ...
                    try {
                        ...
                        resolvable.startResolutionForResult(HomePleaseSelectMarket.this,
...
//                getSupportFragmentManager()
//                        .beginTransaction()
//                        .replace(R.id.fragment_container, MarketsFragmentNew.newInstance(), TAG_MARKET_FRAGMENT)
//                        .commit();
//            }
//
//
...
//        }
    ...
    void showProfileBackup(boolean refreshFragment)
    {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(PrefGeneral.getServiceURL(HomePleaseSelectMarket.this)==null)
                        {
