package org.nearbyshops.whitelabelapp.Lists.ShopsAvailableForItem.Backup;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        //{
            ...
            if(cartStats!=null)
            {
                ...
                holder.cartTotal.setText("Cart Total : "  + PrefCurrency.getCurrencySymbol(context) + " " + cartStats.getCart_Total());
            }
        //}
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            */
                    ...
                    cartTotal.setText("Cart Total : " + PrefCurrency.getCurrencySymbol(context) + " "+ (cartTotalNeutral() + total));
