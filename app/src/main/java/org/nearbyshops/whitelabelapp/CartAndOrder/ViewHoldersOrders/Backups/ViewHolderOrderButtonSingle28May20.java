package org.nearbyshops.whitelabelapp.CartAndOrder.ViewHoldersOrders.Backups;
...
public class ViewHolderOrderButtonSingle28May20 extends ViewHolderOrder {
    ...
    public static ViewHolderOrderButtonSingle28May20 create(ViewGroup parent, Context context, Fragment fragment, boolean isModeDelivery)
    {

        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_order_button_single,parent,false);

        return new ViewHolderOrderButtonSingle28May20(view,context,fragment,isModeDelivery);
    }
    ...
    public ViewHolderOrderButtonSingle28May20(View itemView, Context context, Fragment fragment, boolean isModeDelivery) {
