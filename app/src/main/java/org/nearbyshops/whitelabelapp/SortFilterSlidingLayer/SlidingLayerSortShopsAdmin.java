...
import org.nearbyshops.whitelabelapp.SortFilterSlidingLayer.PreferencesSort.PrefSortShopsAdmin;
...
public class SlidingLayerSortShopsAdmin extends Fragment {
...
//        String[] sort_options = UtilitySortShopItem.getSort(getActivity());
        ...
        currentSort = PrefSortShopsAdmin.getSort(getActivity());
        currentAscending = PrefSortShopsAdmin.getAscending(getActivity());
...
//        }
    ...
    void sortByNameClick(View view)
    {
        ...
        PrefSortShopsAdmin.saveSort(getActivity(),SORT_BY_DISTANCE);
    ...
    void sortByCreated(View view)
    {
        ...
        PrefSortShopsAdmin.saveSort(getActivity(),SORT_BY_RATING);
...
//    }
    ...
    void ascendingClick(View view)
    {
        ...
        PrefSortShopsAdmin.saveAscending(getActivity(),SORT_ASCENDING);
    ...
    void descendingClick(View view)
    {
        ...
        PrefSortShopsAdmin.saveAscending(getActivity(),SORT_DESCENDING);
