package org.nearbyshops.whitelabelapp.EditDataScreens.EditShopStaffPermissions;
...
//        setContentView(R.layout.activity_edit_address);
    ...
    private void getStaffPermissions()
    {
        ...
        Call<ShopStaffPermissions> call = staffShopService.getUserDetails(
...
//            permitMarkOrdersDelivered.setChecked(permissions.isPermitMarkOrdersDelivered());
    ...
    private void updatePermissions()
    {
        ...
        Call<ResponseBody> call = staffShopService.updateStaffPermissions(
                PrefLogin.getAuthorizationHeader(getActivity()),
                permissions
        );
