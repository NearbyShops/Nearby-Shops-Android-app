...
//            clearFilterRoles.setVisibility(View.VISIBLE);
    ...
    {
        saveFilterByRole(context,User.ROLE_DELIVERY_GUY_SHOP_CODE);
        bindFilterUserRoles(true);
    }
    ...
    private void bindFilterUserRoles(boolean notifyUpdate)
    {
        ...
        else if(userRole==User.ROLE_DELIVERY_GUY_MARKET_CODE ||userRole==User.ROLE_DELIVERY_GUY_SHOP_CODE)
        {
