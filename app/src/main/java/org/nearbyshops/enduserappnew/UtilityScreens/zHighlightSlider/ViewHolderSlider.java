...
public class ViewHolderSlider extends RecyclerView.ViewHolder {
    ...
    public static ViewHolderSlider create(ViewGroup parent, Context context, Fragment fragment)
    {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_horizontal_list,parent,false);

        return new ViewHolderSlider(view,context,fragment);
    }
    ...
    public ViewHolderSlider(@NonNull View itemView, Context context, Fragment fragment) {
        super(itemView);
