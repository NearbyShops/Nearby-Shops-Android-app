...
//                + sliderItem.getImageFilename() + ".jpg";
            ...
            String imagePathSmall = PrefGeneral.getServerURL(context) + "/api/v1/ItemImage/Image/nine_hundred_" + sliderItem.getImageFilename() + ".jpg";
        ...
        else if(mSliderItems.get(position) instanceof Item)
        {
            ...
            String imagePath = PrefGeneral.getServerURL(context) + "/api/v1/Item/Image/seven_hundred_"
