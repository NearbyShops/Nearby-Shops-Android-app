package org.nearbyshops.whitelabelapp.InventoryOrders.FilterDeliveryGuy;
...
//                .getNetComponent().Inject(this);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolderTripRequest) {
            ...
            if (dataset.get(position) instanceof org.nearbyshops.whitelabelapp.ViewHolders.ViewHoldersCommon.ViewHolderHeader.HeaderTitle) {
                org.nearbyshops.whitelabelapp.ViewHolders.ViewHoldersCommon.ViewHolderHeader.HeaderTitle header = (org.nearbyshops.whitelabelapp.ViewHolders.ViewHoldersCommon.ViewHolderHeader.HeaderTitle) dataset.get(position);
...
//            itemCount = dataset.size();
    ...
    public int getItemViewType(int position) {
        ...
        } else if (dataset.get(position) instanceof org.nearbyshops.whitelabelapp.ViewHolders.ViewHoldersCommon.ViewHolderHeader.HeaderTitle) {
...
//            holder.distance.setText("Distance : " + String.format("%.2f Km",permissions.getRt_distance()));
            ...
            String imagePath = PrefGeneral.getServerURL(context) + "/api/v1/User/Image/" + "five_hundred_"+ tripRequest.getProfileImagePath() + ".jpg";
            String image_url = PrefGeneral.getServerURL(context) + "/api/v1/User/Image/" + tripRequest.getProfileImagePath();
