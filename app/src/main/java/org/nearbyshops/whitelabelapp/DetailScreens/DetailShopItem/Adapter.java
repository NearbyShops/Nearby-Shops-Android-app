package org.nearbyshops.whitelabelapp.DetailScreens.DetailShopItem;
...
import org.nearbyshops.whitelabelapp.DetailScreens.DetailItemNew.AdapterItemImages;
...
public class Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        {
            return ViewHolderShopItemDetail.create(parent,context,fragment);
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        else if(holder instanceof ViewHolderShopItemDetail)
        {
            ((ViewHolderShopItemDetail) holder).setItem((Item) dataset.get(position));
        }
