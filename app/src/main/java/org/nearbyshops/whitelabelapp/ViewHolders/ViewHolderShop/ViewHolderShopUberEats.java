...
public class ViewHolderShopUberEats extends RecyclerView.ViewHolder implements PopupMenu.OnMenuItemClickListener {
    ...
    public static ViewHolderShopUberEats create(ViewGroup parent, Context context, Fragment fragment,
                                                RecyclerView.Adapter adapter)
    {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_shop_uber_eats,parent,false);
        return new ViewHolderShopUberEats(view,context,fragment, adapter);
    }
    ...
    public ViewHolderShopUberEats(@NonNull View itemView, Context context, Fragment fragment, RecyclerView.Adapter adapter) {
        super(itemView);
        ...
        viewModelShop.getEvent().observe(fragment.getViewLifecycleOwner(), new Observer<Integer>() {
            ...
            public void onChanged(Integer integer) {
                ...
                {
                    ViewHolderShopUberEats.this.adapter.notifyItemRemoved(getAdapterPosition());
                }
