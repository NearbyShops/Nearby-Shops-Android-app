package org.nearbyshops.whitelabelapp.PlacePickers.PlacePickerGoogleMaps.Deprecated;
...
//                                );
    ...
    void myLocation()
    {
        ...
        if(googleMapInstance!=null)
        {
            ...
            LatLng latLng = new LatLng(PrefLocation.getLatitudeSelected(getActivity()),
