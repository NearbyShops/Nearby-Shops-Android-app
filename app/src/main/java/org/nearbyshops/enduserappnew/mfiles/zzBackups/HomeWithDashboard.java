package org.nearbyshops.enduserappnew.mfiles.zzBackups;
...
import org.nearbyshops.enduserappnew.aSellerModule.DashboardDeliveryGuy.DeliveryGuyHomeFragment;
import org.nearbyshops.enduserappnew.aSellerModule.DashboardShopAdmin.ShopAdminHomeFragment;


public class HomeWithDashboard extends AppCompatActivity implements ShowFragment, NotifyAboutLogin, MarketSelected {
    ...
    public static final String TAG_SHOP_ADMIN_HOME = "tag_shops_admin_home";
    public static final String TAG_DELIVERY_DASHBOARD = "tag_delivery_dashboard";
    ...
    void checkLocationSettings()
    {
        ...
        task.addOnSuccessListener(this, new OnSuccessListener<LocationSettingsResponse>() {
            ...
            public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                ...
                startService(new Intent(HomeWithDashboard.this, LocationService.class));
            }
        });
            ...
            public void onFailure(@NonNull Exception e) {
                if (e instanceof ResolvableApiException) {
                    ...
                    try {
                        ...
                        resolvable.startResolutionForResult(HomeWithDashboard.this,
    ...
    public void showOrdersFragment() {
        ...
        if (user == null) {
            ...
            if(user.getRole()==User.ROLE_SHOP_ADMIN_CODE)
            {
                ...
                if(getSupportFragmentManager().findFragmentByTag(TAG_SHOP_ADMIN_HOME)==null)
                {
                    getSupportFragmentManager()
                            .beginTransaction()
                            .replace(R.id.fragment_container, new ShopAdminHomeFragment(), TAG_SHOP_ADMIN_HOME)
                            .commitNow();
            ...
            else if(user.getRole()==User.ROLE_DELIVERY_GUY_SELF_CODE || user.getRole()==User.ROLE_DELIVERY_GUY_CODE)
            {
                ...
                if(getSupportFragmentManager().findFragmentByTag(TAG_DELIVERY_DASHBOARD)==null)
                {
                    getSupportFragmentManager()
                            .beginTransaction()
                            .replace(R.id.fragment_container, new DeliveryGuyHomeFragment(), TAG_DELIVERY_DASHBOARD)
                            .commitNow();
        ...
        dialog.setTitle("Do you want to exit ?")
                ...
                .setPositiveButton("Yes",new DialogInterface.OnClickListener(){
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        HomeWithDashboard.super.onBackPressed();
