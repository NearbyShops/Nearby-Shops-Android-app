package org.nearbyshops.whitelabelapp.Services.NonStopServices;
...
//        locationManager.requestLocationUpdates( 15000, 100,criteria, locationListener,null);
    ...
    void updateLocation(Location location)
    {
        ...
        Call<ResponseBody> call = deliveryGuyService.updateLocation(PrefLogin.getAuthorizationHeader(getApplicationContext()),
                data);
