...
public class LoginUsingOTPFragmentBackup extends Fragment {
...
//    @BindView(R.id.login_message) TextView loginMessage;
    ...
    public LoginUsingOTPFragmentBackup() {
...
//                .Inject(this);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_login_using_otp_global_backup, container, false);
...
//        boolean phoneEnabled = getResources().getBoolean(R.bool.login_using_phone_enabled);
        boolean phoneEnabled = PrefCurrency.isPhoneLoginEnabled(requireActivity());
