...
public class ViewHolderFilterShopsAdmin extends RecyclerView.ViewHolder {
    ...
    public static String SORT_BY_RATING = Shop.SHOP_NAME;
    ...
    @OnClick({R.id.sort_by_new, R.id.clear_sort})
    void sortNewClick()
    {
    ...
    @OnClick({R.id.sort_high_to_low,R.id.clear_sort_order})
    ...
    public static String getSortBy(Context context)
    {
        ...
        return sharedPref.getString("sort_shops_admin", SORT_BY_NEW);
    }
    ...
    {
        SharedPreferences sharedPref = context.getSharedPreferences(context.getString(R.string.preference_file_name), MODE_PRIVATE);
        return sharedPref.getString("sort_shops_order_admin", SORT_DESCENDING);
    }
