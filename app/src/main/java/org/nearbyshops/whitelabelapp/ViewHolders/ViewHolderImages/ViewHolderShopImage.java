package org.nearbyshops.whitelabelapp.ViewHolders.ViewHolderImages;
...
public class ViewHolderShopImage extends RecyclerView.ViewHolder{
    ...
    public void setShopImage(ShopImage shopImage, boolean isAdminMode)
    {
        ...
        String imagePathSmall = PrefGeneral.getServerURL(context) + "/api/v1/ShopImage/Image/five_hundred_" + shopImage.getImageFilename() + ".jpg";
        String imagePathMedium = PrefGeneral.getServerURL(context) + "/api/v1/ShopImage/Image/nine_hundred_" + shopImage.getImageFilename() + ".jpg";
        String imagePathFullSize = PrefGeneral.getServerURL(context) + "/api/v1/ShopImage/Image/" + shopImage.getImageFilename();
