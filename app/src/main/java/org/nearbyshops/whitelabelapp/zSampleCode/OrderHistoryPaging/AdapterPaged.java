...
//        this.dataset = dataset;
    ...
    public int getItemViewType(int position) {
        ...
        else if(item instanceof ViewHolderEmptyScreenFullScreen.EmptyScreenDataFullScreen)
        {
...
//            }
        ...
        {
            ((ViewHolderEmptyScreenFullScreen) holderVH).setItem((ViewHolderEmptyScreenFullScreen.EmptyScreenDataFullScreen) getItem(position));
        }
