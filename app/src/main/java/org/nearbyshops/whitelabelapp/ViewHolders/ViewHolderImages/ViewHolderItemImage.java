...
public class ViewHolderItemImage extends RecyclerView.ViewHolder{
    ...
    public void setItemImage(ItemImage itemImage)
    {
        ...
        String imagePathSmall = PrefGeneral.getServerURL(context) + "/api/v1/ItemImage/Image/nine_hundred_" + itemImage.getImageFilename() + ".jpg";
...
//            }
    ...
    public void setItem(Item item)
    {
        ...
        String imagePath = PrefGeneral.getServerURL(context) + "/api/v1/Item/Image/nine_hundred_"
