...
//        ratingCount.setText("(" + item.getRt_rating_count() + " ratings )");
        ...
        itemPrice.setText(PrefCurrency.getCurrencySymbol(context)
        ...
        {
            listPrice.setText(PrefCurrency.getCurrencySymbol(context) + " " + UtilityFunctions.refinedString(item.getListPrice()));
