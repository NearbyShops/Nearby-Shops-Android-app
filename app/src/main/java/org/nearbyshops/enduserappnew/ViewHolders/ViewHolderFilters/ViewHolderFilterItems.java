...
//        clearSort.setVisibility(View.VISIBLE);
        ...
        if(getSortBy(context).equals(SORT_BY_BESTSELLER))
        {
            ...
            sortByBestseller.setBackgroundColor(ContextCompat.getColor(context,R.color.mapbox_blue));
//            clearSort.setVisibility(View.INVISIBLE);
        ...
        else if(getSortBy(context).equals(SORT_BY_HIGHEST_DISCOUNT))
        {
            ...
            sortByDiscount.setBackgroundColor(ContextCompat.getColor(context,R.color.mapbox_blue));
        }
        ...
        else if(getSortBy(context).equals(SORT_BY_PRICE_LOWEST))
        {
            ...
            sortByPriceLowest.setBackgroundColor(ContextCompat.getColor(context,R.color.mapbox_blue));
        }
        else if(getSortBy(context).equals(SORT_BY_PRICE_HIGHEST))
        {
            ...
            sortByPriceHighest.setBackgroundColor(ContextCompat.getColor(context,R.color.mapbox_blue));
        }
        ...
        else if(getSortBy(context).equals(SORT_BY_AVAILABLE_HIGHEST))
        {
            ...
            sortByAvailableHighest.setBackgroundColor(ContextCompat.getColor(context,R.color.mapbox_blue));
        }
        else if(getSortBy(context).equals(SORT_BY_AVAILABLE_LOWEST))
        {
            ...
            sortByAvailableLowest.setBackgroundColor(ContextCompat.getColor(context,R.color.mapbox_blue));
        }
