...
public class ViewHolderOrderShopAdminHD extends ViewHolderOrder {
    ...
    void setupCancelButton()
    {
        if(order.getStatusCurrent()==OrderStatusHomeDelivery.ORDER_PLACED||
                ...
                order.getStatusCurrent()==OrderStatusHomeDelivery.RETURNED_ORDERS)
        {
    ...
    void setupButtons()
    {
        ...
        if(order.getDeliveryGuyID() >0 && order.getRt_delivery_guy_profile()!=null)
        {
