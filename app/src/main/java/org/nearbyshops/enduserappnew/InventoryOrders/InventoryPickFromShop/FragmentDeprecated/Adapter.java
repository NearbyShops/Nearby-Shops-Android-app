package org.nearbyshops.enduserappnew.InventoryOrders.InventoryPickFromShop.FragmentDeprecated;
...
class Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public int getItemViewType(int position) {
        ...
        else if(dataset.get(position) instanceof Order)
        {
            ...
            {
                if((order.getStatusPickFromShop()== OrderStatusPickFromShop.DELIVERED))
                {
